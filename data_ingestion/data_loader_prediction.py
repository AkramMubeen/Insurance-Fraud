...
class Data_Getter_Pred:
    """
    This class is responsible for obtaining prediction data from a specified source.
    ...
    def get_data(self):
        ...
        Returns:
        pandas.DataFrame: The prediction data.
        ...
        try:
            self.data= pd.read_csv(self.prediction_file) # reading the data
